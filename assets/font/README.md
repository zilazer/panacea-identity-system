...
- `source/panacea-alphabet-4th.svg`: 当前第四版矢量字形 / active fourth-version vector glyphs
- `source/panacea-alphabet-3rd.svg`: 保留的第三版矢量字形 / retained third-version vector glyphs
